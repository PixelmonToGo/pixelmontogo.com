...
if (navigator.userAgent.indexOf('Mac OS X') !== -1) {
  downloadLink.href = 'https://pixelmontogo.com/download/PixelmonToGoLauncher-mac-radfish.dmg'
  platform.textContent = 'DOWNLOAD PIXELMON (MAC)'
} else if (navigator.userAgent.indexOf('Linux') !== -1) {
  downloadLink.href = 'https://pixelmontogo.com/download/PixelmonToGoLauncher-linux-radfish.AppImage'
  platform.textContent = 'DOWNLOAD PIXELMON (LINUX)'
} else {
  downloadLink.href = 'https://pixelmontogo.com/download/PixelmonToGoLauncher-windows-radfish.exe'
